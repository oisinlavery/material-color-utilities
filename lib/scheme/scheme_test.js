...
require("jasmine");
const scheme_1 = require("scheme/scheme");
const scheme_android_1 = require("scheme/scheme_android");
...
describe('scheme', () => {
    it('blue light scheme', () => {
        const scheme = scheme_1.Scheme.light(0xff0000ff);
        expect(scheme.primary).matchesColor(0xff333CFF);
    });
    it('blue dark scheme', () => {
        const scheme = scheme_1.Scheme.dark(0xff0000ff);
        expect(scheme.primary).matchesColor(0xffBDC2FF);
    });
    it('3rd party light scheme', () => {
        const scheme = scheme_1.Scheme.light(0xff6750A4);
    ...
    it('3rd party dark scheme', () => {
        const scheme = scheme_1.Scheme.dark(0xff6750A4);
...
describe('android scheme', () => {
    it('blue light scheme', () => {
        const scheme = scheme_android_1.SchemeAndroid.light(0xff0000ff);
        expect(scheme.colorAccentPrimary).matchesColor(0xffdfe0ff);
    });
    it('blue dark scheme', () => {
        const scheme = scheme_android_1.SchemeAndroid.dark(0xff0000ff);
        expect(scheme.colorAccentPrimary).matchesColor(0xffdfe0ff);
    });
    it('3rd party light scheme', () => {
        const scheme = scheme_android_1.SchemeAndroid.light(0xff6750A4);
    ...
    it('3rd party dark scheme', () => {
        const scheme = scheme_android_1.SchemeAndroid.dark(0xff6750A4);
        expect(scheme.colorAccentPrimary).matchesColor(0xffeaddff);
        expect(scheme.colorAccentSecondary).matchesColor(0xffe8def8);
        expect(scheme.colorAccentTertiary).matchesColor(0xffffd8e4);

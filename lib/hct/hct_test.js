...
const viewing_conditions_1 = require("hct/viewing_conditions");
...
describe('CAM to ARGB', () => {
    it('red', () => {
        const cam = cam16_1.CAM16.fromInt(RED);
    ...
    it('green', () => {
        const cam = cam16_1.CAM16.fromInt(GREEN);
    ...
    it('blue', () => {
        const cam = cam16_1.CAM16.fromInt(BLUE);
    ...
    it('white', () => {
        const cam = cam16_1.CAM16.fromInt(WHITE);
    ...
    it('black', () => {
        const cam = cam16_1.CAM16.fromInt(BLACK);
...
describe('viewing conditions', () => {
    it('default', () => {
        const vc = viewing_conditions_1.ViewingConditions.DEFAULT;

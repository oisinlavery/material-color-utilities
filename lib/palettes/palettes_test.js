...
require("jasmine");
const core_palette_1 = require("palettes/core_palette");
const tonal_palette_1 = require("palettes/tonal_palette");
describe('TonalPalette', () => {
    it('ofBlue', () => {
        const blue = tonal_palette_1.TonalPalette.fromInt(0xff0000ff);
...
describe('CorePalette', () => {
    it('ofBlue', () => {
        const core = core_palette_1.CorePalette.of(0xff0000ff);
